...
<html>
	...
	<body>
		<div class="container">
			...
			<h3 align="center">ADMINISTRADOR DATOS USUARIOS</h3>
			<br />
...
$(document).ready(function(){
	...
	$('#api_crud_form').on('submit', function(event){
		...
		{
			alert("Ingrese apellido_p");
		}
		else if($('#apellido_m').val() == '')
		{
			alert("Ingresar apellido_m");
		}
		...
		{
			alert("Ingrese telefono personal");
		}
		else
		{
	...
	$(document).on('click', '.edit', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$('.modal-title').text('Modificar Datos User');
				$('#apicrudModal').modal('show');
			}
		})
	});
