...
<html>
	...
	<body>
		<div class="container">
			...
			<h3 align="center">ADMINISTRADOR DATOS PRODUCTOS</h3>
			<br />
				...
				<div class="modal-header">
		      	...
		      	<div class="modal-body">
		      		<div class="form-group">
			        	<label>img_pro</label>
			        	<input type="text" name="img_pro" id="img_pro" class="form-control" />
			        </div>
			        <div class="form-group">
...
$(document).ready(function(){
	...
	$('#api_crud_form').on('submit', function(event){
		...
		if($('#img_pro').val() == '')
		{
			alert("Ingresar img_pro");
		}
		else if($('#nom_producto').val() == '')
		{
			alert("Ingrese nom_producto");
		}
		else
		{
			var form_data = $(this).serialize();
			$.ajax({
				url:"action_productos.php",
				method:"POST",
				data:form_data,
				success:function(data)
				{
	...
	$(document).on('click', '.edit', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				$('#hidden_id').val(data.id_producto);
				$('#img_pro').val(data.img_pro);
